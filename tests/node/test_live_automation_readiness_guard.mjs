...
test('live automation readiness remains review-only', () => {
  ...
  for (const marker of [
    ...
    'WAITING_USDJPY_FOREX_EVIDENCE_INPUTS',
    'USDJPY_REVIEW_INPUTS_PRESENT',
    'evidence-intake',
    ...
    'FOREX_SHORTLIST_READY',
    'FOREX_TESTER_REVIEW_READY',
    'selectedLaneForSeparateReleaseReview',
    'ace-execution-candidate-pack',
    'quantgod.ace_upgrade_action_plan.v1',
    'QuantGod_AceUpgradeActionPlan.json',
    'ace-upgrade-action-plan',
    'ACE_UPGRADE_READY_FOR_FOREX_TESTER_REVIEW',
...
test('dashboard exposes live automation readiness namespace', () => {
  ...
  for (const marker of [
    ...
    'LATEST_DASHBOARD_WRITER_EVIDENCE_WATCH',
