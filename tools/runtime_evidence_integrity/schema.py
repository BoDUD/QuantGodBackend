...
CORE_ARTIFACTS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "path": "adaptive/QuantGod_USDJPYAutoExecutionPolicy.json",
        "contentType": "json",
        "expectedSchemas": ["quantgod.usdjpy_auto_execution_policy.v1"],
        "required": True,
        "requiresDeclaredVersion": True,
    },
    {
        ...
        "category": "production-policy",
        "path": "adaptive/QuantGod_USDJPYAutoExecutionPolicyLedger.csv",
        "contentType": "csv",
        "expectedSchemas": ["quantgod.usdjpy_auto_execution_policy_ledger.v1"],
        "required": True,
    },
    {
