#!/usr/bin/env python3
"""CLI for the read-only G0077 champion tester lock draft."""
...
try:
    from tools.champion_tester_lock_draft import build_champion_tester_lock_draft, read_champion_tester_lock_draft
...
def main(argv=None) -> int:
    ...
    parser = argparse.ArgumentParser(description="QuantGod read-only G0077 champion tester lock draft")
